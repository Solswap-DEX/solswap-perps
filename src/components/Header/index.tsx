...
const SolSwapLogo = () => (
  <svg width="140" height="30" viewBox="0 0 140 30" fill="none">
    <text
      ...
      fontSize="24"
      fontWeight="900"
      fill="url(#solswap_perps_gradient)"
      letterSpacing="-0.5"
    >
      SOLSWAP
    </text>
    <defs>
      <linearGradient id="solswap_perps_gradient" x1="0" y1="0" x2="140" y2="0" gradientUnits="userSpaceOnUse">
    ...
    <>
      <header className="h-16 border-b border-[#0D1117] bg-[#05070A] flex items-center justify-between px-3 md:px-6 sticky top-0 z-50">
        <div className="flex items-center gap-4 md:gap-8">
          <Link href="/" className="flex items-center gap-2">
            <SolSwapLogo />
            <span className="bg-[#0D1117] text-[#00E5A0] text-[10px] md:text-xs px-2 py-1 rounded font-mono">PERPS</span>
          </Link>
          
          <nav className="hidden md:flex items-center gap-6 font-medium text-[15px]">
            <a href="https://solswap.cloud/swap/" className="text-[#8B8EA8] hover:text-[#00E5A0] transition-colors">
              Swap
            </a>
            <a href="https://solswap.cloud/liquidity-pools/" className="text-[#8B8EA8] hover:text-[#00E5A0] transition-colors">
              Liquidity
            </a>
            <a href="https://solswap.cloud/portfolio/" className="text-[#8B8EA8] hover:text-[#00E5A0] transition-colors">
              Portfolio
            </a>
            <a href="https://solswap.cloud/bridge/" className="text-[#8B8EA8] hover:text-[#00E5A0] transition-colors">
              Bridge
            </a>
            <Link href="/trade" className="text-[#00E5A0] border-b-2 border-[#00E5A0] h-16 flex items-center font-bold">
              Perpetuals
            </Link>
          </nav>
        </div>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-[#05070A] border-t border-[#0D1117] flex items-center justify-around px-2 z-[100] safe-area-inset-bottom">
        <a href="https://solswap.cloud/swap/" className="flex flex-col items-center gap-1 group">
          <div className="text-[#8B8EA8] group-hover:text-[#00E5A0] transition-colors">
        ...
        <Link href="/trade" className="flex flex-col items-center gap-1 group">
          ...
          <span className="text-[9px] text-[#00E5A0] font-medium uppercase tracking-tighter">Trade</span>
        </Link>
      </nav>
    </>
  );
